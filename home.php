        ...
        <section class="img-principal-home">
            ...
            <div class="mudar-slides">
                ...
                <div class="slide-restaurantes">
                    ...
                    <a href="restaurantes.php"> <button type="button"> Avaliar</button></a>
                </div>
            ...
            <div class="coluna">
                ...
                <div class="opcao-restaurantes d-flex">
                    ...
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal1">
                    ...
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal2">
                    ...
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal3">
                    ...
                    <!-- MODAL 1 -->
                    <div class="modal fade" id="restaurantsModal1" tabindex="-1"
                        aria-labelledby="restaurantsModalLabel1" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel1">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <ul id="restaurantsList2" class="list-group">
                                        ...
                                        <li class="list-group-item">Modal 7 teste</li>
                                    </ul>
                                </div>
                    ...
                    <div class="modal fade" id="restaurantsModal2" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel2">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    <input type="text" id="searchInput1" class="form-control mb-3"
                    ...
                    <div class="modal fade" id="restaurantsModal3" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel3">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    <input type="text" id="searchInput1" class="form-control mb-3"
                ...
                <div class="opcao-restaurantes2 d-flex">
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal4">
                    ...
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal5">
                    ...
                    <div class="modal-button">
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#restaurantsModal6">
                    ...
                    <div class="modal fade" id="restaurantsModal4" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel4">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    <input type="text" id="searchInput1" class="form-control mb-3"
                    ...
                    <div class="modal fade" id="restaurantsModal5" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel5">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    <input type="text" id="searchInput1" class="form-control mb-3"
                    ...
                    <div class="modal fade" id="restaurantsModal6" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurantsModalLabel6">Qual restaurante voce deseja
                                        pesquisar?</h5>
                                </div>
                                <div class="modal-body">
                                    <input type="text" id="searchInput1" class="form-control mb-3"
