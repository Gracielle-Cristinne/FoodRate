        ...
        <form id="formCadastro" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <section class="input-box">
                ...
                <div class="box-SenhaCadastro">
                    <input type="password" id="inputSenhaCadastro" name="inputSenha" placeholder="Senha"  minlength="7" required>
                    <div id="icon2" onclick="showHide1()"></div>
                </div>
                
                <div class="box-confirm-SenhaCadastro">
                    <input type="password" id="inputConfirmSenha" name="inputConfirmSenha"  minlength="7" placeholder="Confirme a senha" required>
