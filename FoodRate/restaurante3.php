...
<body class="body-Restaurantes">
    ...
    <main class="main-Restaurantes">
        ...
        <section class="info-restaurante">
            <h3>Nome do restaurante: Chapa Burgueria</h3>
            <h3>Telefone: (81) 5555-5555</h3>
            <h3>Endereço: Rua do Chacon, 64 - Poço da Panela, Recife - PE, 52061-400</h3>
        </section>
        ...
        <section class="restaurente-cardapio">
            ...
            <div class="opcao1">
                <button type="button">
                    <img src="img/option17.png">
                    <div class="info">
                        <h3>Produto mais vendido: Cheeseburger Clássico</h3>
                        <br>
                        <h3>Valor: R$ 25,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com queijo cheddar derretido, alface, tomate,
                            cebola roxa, picles e maionese em um pão de hambúrguer.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao2">
                <button type="button">
                    <img src="img/option18.png">
                    <div class="info">
                        <h3>Opção para você: Bacon Burger </h3>
                        <br>
                        <h3>Valor: R$ 30,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com queijo cheddar, fatias de bacon crocante,
                            alface, tomate e maionese em um pão de hambúrguer.
                        </h3>
                    </div>
                </button>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option19.png">
                    <div class="info">
                        <h3>Opção para você: Chicken Burger </h3>
                        <br>
                        <h3>Valor: R$ 28,00</h3>
                        <br>
                        <h3>Hambúrguer de frango grelhado ou empanado, com alface, tomate, queijo suíço, maionese e um
                            toque de mostarda dijon em um pão de hambúrguer.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option20.png">
                    <div class="info">
                        <h3>Opção para você: Veggie Burger </h3>
                        <br>
                        <h3>Valor: R$ 27,00</h3>
                        <br>
                        <h3> Hambúrguer vegetariano feito de grão-de-bico, feijão preto ou legumes, servido com alface,
                            tomate, cebola roxa, picles e maionese vegana em um pão integral.</h3>
                    </div>
                </button>
            </div>
        </section>
        ...
        <section class="restaurente-cardapio">
            ...
            <div class="opcao1">
                <button type="button">
                    <img src="img/option21.png">
                    <div class="info">
                        <h3>Produto mais vendido: BBQ Burger</h3>
                        <br>
                        <h3>Valor: R$ 32,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com queijo cheddar, cebolas caramelizadas,
                            bacon crocante e molho barbecue, servido em um pão de hambúrguer.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao2">
                <button type="button">
                    <img src="img/option22.png">
                    <div class="info">
                        <h3>Opção para você: Blue Cheese Burger </h3>
                        <br>
                        <h3>Valor: R$ 35,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com queijo gorgonzola, rúcula, cebola roxa e um
                            toque de maionese de alho em um pão de hambúrguer.
                        </h3>
                    </div>
                </button>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option24.png">
                    <div class="info">
                        <h3>Opção para você: Avocado Burger </h3>
                        <br>
                        <h3>Valor: R$ 34,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com fatias de abacate, alface, tomate, queijo
                            suíço e maionese de alho em um pão de hambúrguer.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option25.png">
                    <div class="info">
                        <h3>Opção para você: Mushroom Swiss Burger</h3>
                        <br>
                        <h3>Valor: R$ 33,00</h3>
                        <br>
                        <h3>Hambúrguer de carne bovina grelhado, coberto com cogumelos salteados, queijo suíço
                            derretido, alface, tomate e maionese em um pão de hambúrguer.</h3>
                    </div>
                </button>
            </div>
        </section>
    ...
    <form id="comment-form" action="restaurante3.php" method="POST">  
