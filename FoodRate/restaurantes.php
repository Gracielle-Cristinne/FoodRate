...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo '<div id="comments" class="usuario">';
        echo 'Comentário: ' . $row["comentario"] . ' - Usuário: ' . $row["nome"];
        echo '</div>';
    }
    echo '</div>';
} else {
...
<i class='bx bx-star star bx-rotate-270' style='color:#f1ff02' ></i>         
        ...
        <section class="info-restaurante">
            <h3>Nome do restaurante: China Restaurante</h3>
            <h3>Telefone: (81) 5555-5555</h3>
            <h3>Endereço: Av. Mal. Mascarenhas de Morais, 5109 - Imbiribeira, Recife - PE, 51180-001 </h3>
        </section>
        ...
        <section class="restaurente-cardapio">
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option5.jpg">
                    <div class="info">
                        <h3>Opção para você: Kung Pao Chicken </h3>
                        <br>
                         <h3>Valor: R$ 35,00</h3>
                        <br>
                        <h3> prato é uma mistura de frango em pedaços, amendoim, óleo de gergelim, temperos e pimentas. Originário de Sichuan, é um prato mais recente, criado no século 19, e é quase sinônimo de culinária chinesa.</h3>
                    </div>
                </button>
            </div>
</section>
        ...
        <h3>Combos & Promoções Mais Avaliados <img src="img/iconPromocoes.png">:</h3>   
            ...
            <div class="opcao1">
                <button type="button">
                    ...
                    <div class="info">
                        <h3>Produto mais vendido:  Porco Agridoce</h3>
                        <br>
                        <h3>Valor: R$ 30,00</h3>
                        <br>
                        <h3>É uma receita que remonta a mais de 2200 anos e é apreciada em todo o país. O prato é feito com carne de porco em um molho agridoce, geralmente acompanhado de vegetais.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao2">
                <button type="button">
                    <img src="img/option6.jpg">
                    <div class="info">
                        <h3>Opção para você: Wontons </h3>
                        <br>
                        <h3>Valor: R$ 20,00</h3>
                        <br>
                        <h3>Uma receita típica do Cantão, no sul da China, que se popularizou em várias partes da Ásia. São pequenos pacotes de massa fina recheados com carne de porco ou camarão, podendo ser cozidos no vapor, fritos ou servidos em sopa.
                        </h3>
                    </div>
                </button>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option7.jpg">
                    <div class="info">
                        <h3>Opção para você: Kung Pao Chicken </h3>
                        <br>
                        <h3>Valor: R$ 38,00</h3>
                        <br>
                        <h3>Originário da província de Sichuan, o prato é feito com pedaços de frango marinados e fritos, misturados com amendoins, pimentões e vegetais como cebola e alho-poró. É temperado com molho de soja, vinagre de arroz, açúcar e óleo de gergelim, além de pimenta Sichuan e pimentas secas, que dão ao prato seu caráter picante e aromático.</h3>
                    </div>
                </button>
            </div>
            ...
            <div class="opcao3">
                <button type="button">
                    <img src="img/option8.jpg">
                    <div class="info">
                        <h3>Opção para você: Rolinho Primavera </h3>
                        <br>
                        <h3>Valor: R$ 60,00</h3>
                        <br>
                        <h3>O pato é preparado de maneira especial, sendo inflado com ar, escaldado, seco e depois assado, o que resulta em uma pele deliciosamente crocante. Tradicionalmente, é servido com panquecas finas, cebolinha, pepino e molho hoisin.</h3>
                    </div>                    
                </button>
...
<section class="comentarios-restaurante">
    ...
    <form id="comment-form" action="restaurantes.php" method="POST">  
